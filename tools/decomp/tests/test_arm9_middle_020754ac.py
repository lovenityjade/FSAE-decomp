...
CONFIG = PROJECT_ROOT / "config/decomp/arm9-middle-020754ac.json"
SOURCE = PROJECT_ROOT / "src/arm9/game/arm9_middle_020754ac_raw.c"
HEADER = PROJECT_ROOT / "include/game/arm9_middle_020754ac_raw.h"
...
class Arm9Middle020754acRecoveryTests(unittest.TestCase):
    @classmethod
    ...
    def test_unique_config_closes_at_32_functions(self) -> None:
        ...
        self.assertEqual(selection["entry_min"], "0x020754ac")
        self.assertEqual(selection["entry_max"], "0x0207649c")
        self.assertEqual(selection["last_body_end"], "0x02076534")
        self.assertEqual(selection["next_entry"], "0x02076538")
        self.assertEqual(selection["function_count"], 32)
        self.assertEqual(selection["body_bytes"], 3836)
        self.assertEqual(selection["pool_bytes"], 400)
        self.assertEqual(selection["span_bytes"], 4236)
        ...
        catalog_index = next(
            ...
            if int(item["entry"], 16) == 0x020754AC
        )
    ...
    def test_rom_body_pool_extent_hashes_and_boundaries(self) -> None:
        ...
        self.assertEqual(total_bodies, 3836)
        self.assertEqual(total_pools, 400)
        self.assertEqual(total_bodies + total_pools, 4236)

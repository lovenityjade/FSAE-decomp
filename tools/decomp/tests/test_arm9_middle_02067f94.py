...
CONFIG = PROJECT_ROOT / "config/decomp/arm9-middle-02067f94.json"
SOURCE = PROJECT_ROOT / "src/arm9/game/arm9_middle_02067f94_raw.c"
HEADER = PROJECT_ROOT / "include/game/arm9_middle_02067f94_raw.h"
...
class Arm9Middle02067f94RecoveryTests(unittest.TestCase):
    @classmethod
    ...
    def test_unique_config_closes_at_32_functions(self) -> None:
        ...
        self.assertEqual(selection["entry_min"], "0x02067f94")
        self.assertEqual(selection["entry_max"], "0x02069378")
        self.assertEqual(selection["last_body_end"], "0x020693f0")
        self.assertEqual(selection["next_entry"], "0x020693fc")
        self.assertEqual(selection["function_count"], 32)
        self.assertEqual(selection["body_bytes"], 4452)
        self.assertEqual(selection["pool_bytes"], 772)
        self.assertEqual(selection["span_bytes"], 5224)
        ...
        catalog_index = next(
            ...
            if int(item["entry"], 16) == 0x02067F94
        )
    ...
    def test_rom_body_pool_extent_hashes_and_boundaries(self) -> None:
        ...
        self.assertEqual(total_bodies, 4452)
        self.assertEqual(total_pools, 772)
        self.assertEqual(total_bodies + total_pools, 5224)
    ...
    def test_raw_bodies_match_export_with_only_documented_repairs(self) -> None:
        ...
        for address in selected:
            ...
            expected = expected.replace(
                "FUN_020690a0();", "FUN_020690a0(param_1);"
            )
